...
class SchemaUpdateCommand extends ContainerAwareCommand
{
    ...
    {
        $connection = $this->getContainer()->get('mongolog_browser.doctrine_dbal.connection');
        $tableName = $this->getContainer()->getParameter('mongolog_browser.doctrine.table_name');
